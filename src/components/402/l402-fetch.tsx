    ...
    <Card>
      ...
      <CardContent className="space-y-3">
        <p className="text-sm text-muted-foreground">
          ...
          <code className="text-xs">WWW-Authenticate</code> header.
        </p>
      ...
      const wallet = {
        payInvoice: async (args: { invoice: string }) => {
          ...
          addFlowStep({
            fromWallet: "alice",
            toWallet: "bob",
            label: `HTTP 402 + WWW-Authenticate: L402 invoice=${amountSats} sats`,
            direction: "right",
            status: "success",
          });
          ...
          step4Id = addFlowStep({
            fromWallet: "bob",
            toWallet: "alice",
            label: "GET /resource + Authorization: L402 token:preimage",
            direction: "left",
            status: "pending",
          });
